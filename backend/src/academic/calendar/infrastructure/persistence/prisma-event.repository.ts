...
} from '../../domain/interfaces/event-repository.interface.js';
import {
  IEventRepository,
  EventWithDetails,
} from '../../domain/interfaces/event-repository.interface.js';
import { EVENT_WITH_DETAILS_INCLUDE as EVENT_INCLUDE } from './prisma-calendar.includes.js';
...
export class PrismaEventRepository extends IEventRepository {
  ...
  async create(dto: CreateEventRepositoryInput) {
  ...
  async update(id: string, dto: UpdateEventRepositoryInput) {
