...
} from '../../domain/interfaces/employment-type-repository.interface.js';
...
export class PrismaEmploymentTypeRepository implements IEmploymentTypeRepository {
  ...
  async findAll(query: EmploymentTypeQueryInput) {
  ...
  async create(dto: CreateEmploymentTypeRepositoryInput) {
  ...
  async update(id: string, dto: UpdateEmploymentTypeRepositoryInput) {
