...
- **An operator of both apps signs in twice.** Sessions are per-origin. Staff who correct gate presence *and* teach will hold two tabs. This is the ongoing tax of the split and the strongest argument that ADR-0007 was right on the operational merits.
