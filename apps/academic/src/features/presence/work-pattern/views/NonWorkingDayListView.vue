...
import { academicCalendarTypeApi } from '@/features/academic/academic-calendar-type'
import type { AcademicCalendarType } from '@/features/academic/academic-calendar-type'
...
const calendarTypes = ref<AcademicCalendarType[]>([])
...
async function loadData() {
  try {
    const [yearsRes, typesRes] = await Promise.all([
      ...
      academicCalendarTypeApi.getAcademicCalendarTypes({
    ...
    calendarTypes.value = typesRes.data?.data ?? []
