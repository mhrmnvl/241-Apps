...
<template>
  <div class="mx-auto max-w-2xl space-y-6 p-6">
    <header>
      <h1 class="text-2xl font-semibold tracking-tight">Beranda</h1>
      <p class="text-sm text-muted-foreground">
        Atur berapa item yang tampil di setiap bagian halaman depan. Perubahan
        langsung terlihat pengunjung — tanpa perlu deploy.
      </p>
    </header>
